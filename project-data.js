...
window.PROJECT_DATA.SOCIAL_LINKS = [
    { id: "whatsapp", icon: "fa-whatsapp", label: "WhatsApp", color: "#25d366" },
    { id: "discord", icon: "fa-discord", label: "Discord", color: "#5865f2" },
    { id: "tiktok", icon: "fa-tiktok", label: "TikTok", color: "#ffffff" },
    { id: "youtube", icon: "fa-youtube", label: "YouTube", color: "#ff0000" }
];

window.PROJECT_DATA.TESTIMONIAL_SOURCE = {
    githubUser: "bam-source",
    githubRepo: "BAM-MACRO-RECOIL",
    githubFolder: "testimoni"
};

window.PROJECT_DATA.PROJECT_CATEGORIES = [
    {
        id: "macro-recoil",
        name: "Project Macro Game",
        label: "MACRO GAME",
        href: "macro-recoil.html",
        icon: "fa-crosshairs",
        desc: "Software macro recoil untuk game dengan support admin dan akses lifetime."
    },
    {
        id: "mod-game-indonesia",
        name: "Project Mod Game",
        label: "MOD GAME",
        href: "mod-game-indonesia.html",
        icon: "fa-screwdriver-wrench",
        desc: "Project mod game siap order dan konsultasi admin."
    }
];

window.PROJECT_DATA.PRODUCTS_BY_CATEGORY = {
    "macro-recoil": [
        {
            id: "pubg-sw-lite",
            name: "PUBG - Lite",
        ...
        },
        {
            ...
            videoId2: "-",
            video2Label: "-",
            desc: "Produk hardware Unit-X sedang dalam pengembangan. Stay tuned untuk update selanjutnya!",
            specs: ["Info segera hadir", "Follow sosial media kami"],
            howto: ["Pantau terus update di Discord & TikTok"]
        }
    ],
    "mod-game-indonesia": [
        {
